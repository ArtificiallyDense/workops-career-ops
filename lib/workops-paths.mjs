...
const runtimeDataDir = runDir('data');

export const paths = {
  cv: dataFile('cv.md'),
  profileYml: dataFile('config', 'profile.yml'),
  proofLibrary: dataFile('proof-library', 'asad-master-proof.md'),
  ...
  scanHistory: join(runtimeDataDir, 'scan-history.tsv'),
  pipeline: join(runtimeDataDir, 'pipeline.md'),
  applications: join(runtimeDataDir, 'applications.md'),
